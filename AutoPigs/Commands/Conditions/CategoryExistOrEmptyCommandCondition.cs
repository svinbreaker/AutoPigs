...
{
    public class CategoryExistOrEmptyCommandCondition : AbstractCommandCondition
    {
        private DatabaseHandler _databaseHandler = AutoPigs.DatabaseHandler;
        private CommandContext Context { get; }
        private string CategoryName { get; }

        public CategoryExistOrEmptyCommandCondition(CommandContext context, string categoryName)
        {
            Context = context;
