...
{
    public class TargetIsPigCommandCondition : AbstractCommandCondition
    {
        ...
        public TargetIsPigCommandCondition(CommandContext context, ChatUser target)
        {
            Context = context;
            Target = target;
        }
        ...
        public override async Task Action()
        {
            ...
            await Context.AnswerAsync(localizer.GetLocalizedString(languageCode, "COMMANDS_ERROR_TARGET_IS_NOT_PIG"), null, true);
        }
    }
}
